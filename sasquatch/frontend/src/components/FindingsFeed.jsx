...
const SA_BG    = "#2a1f15";
// Manufacturer-rollup virtual family
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "6px" }}>
          ...
          {finding.is_family_outlier && (
            <span style={{ background: "#2a1a3a", color: "#b06ad4", border: "1px solid #6a3a8a", borderRadius: "3px", padding: "2px 7px", fontSize: "10px" }}
              title="Family cosine distance: whole family's collective behavior differs from healthy reference">
              Family
            </span>
          )}
    ...
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "6px" }}>
          ...
          {finding.is_family_outlier && (
            <span style={{ background: "#2a1a3a", color: "#b06ad4", border: "1px solid #6a3a8a", borderRadius: "3px", padding: "2px 7px", fontSize: "10px" }}
              title="Family cosine distance: whole family's collective behavior differs from other families at this site">
              Family
            </span>
          )}
          {finding.is_family_dbscan_outlier && (
